...
<div style="background-color:white;color:black;padding:26px;">
  ...
  <hr class="rounded">
  <h5 style="font-family:verdana;"> Why a music blog? </h5>
  <p style="font-family:verdana;"> I liked Anthony Fantano's old music blog so I decided to completely rip his idea off and make my own that is VERY similar but also different. Mr. Melonhead if you are reading this pls don't sue me I'm just a broke college nerd.
  <hr class="rounded">
